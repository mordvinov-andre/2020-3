...
#define DEFAULT_E_AXIS_STEPS_PER_UNIT 205.0 // 410.0 set quite at random 09.11.20 Родион
...
#define Y_HOME_DIR 1// Направление парковки
#define Z_HOME_DIR 1

// @section machine

// The size of the print bed
#define X_BED_SIZE ((HANGPRINTER_PRINTABLE_RADIUS) * 2)// Область печати Родион 14.11.20
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 10
